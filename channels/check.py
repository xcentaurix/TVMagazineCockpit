...
def read_tv_channels():
    ...
    try:
        ...
        json_file_path = os.path.join(current_dir, 'channel_list_sky.json')
...
def read_channel_dict():
    ...
    try:
        ...
        # Path to the JSON file
        json_file_path = os.path.join(current_dir, 'channel_dict_all.json')
...
if __name__ == "__main__":
    ...
    if channels and channel_dict:
        ...
        new_channels = parse_tv_channels(channels, channel_dict)
        ...
        try:
            ...
            output_file_path = os.path.join(current_dir, 'channel_list_sky_new.json')
            
            # Write the updated dictionary to the file
            with codecs.open(output_file_path, 'w', encoding='utf-8') as outfile:
                json.dump(new_channels, outfile, indent=4, ensure_ascii=False)
